...
cnae <- read_excel('C:/Users/User/OneDrive/Documentos/ICE 2021/d5 InovaÁ„o/sd52 Outputs/i522/CNAE20_EstruturaDetalhada.xls', skip = 2) %>%
...
cnae_ice_2 <- read_excel('C:/Users/User/OneDrive/Documentos/ICE 2021/d5 InovaÁ„o/sd52 Outputs/i523/Indicador Tamanho da Economia Criativa.xlsx', sheet = 2) %>%
